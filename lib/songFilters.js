...
export function emptyFilterState() {
  return { songbookIds: [], songbookMode: 'any', sections: [], sectionMode: 'any', includeTagIds: [], includeMode: 'any', excludeTagIds: [], personalTagValues: [], personalTagMode: 'any' };
}
